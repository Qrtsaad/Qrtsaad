...
options(warn = 1)
base::assign(".ExTimings", "OP-Ex.timings", pos = 'CheckExEnv')
...
base::cat("data_generator", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
nameEx("hello")
### * hello
